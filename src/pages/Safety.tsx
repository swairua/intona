...
export default function Safety() {
  return (
    <>
      ...
      <div className="pt-20 sm:pt-24 md:pt-32 safety-hero-bg relative">
        <Section bgColor="bg-accent text-white">
          <Container>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center py-12 md:py-16">
              ...
              >
                <h1 className="text-5xl sm:text-6xl md:text-7xl font-bold text-white mb-6" style={{ fontFamily: 'var(--font-family-display)' }}>Health & Safety</h1>
                <p className="text-base sm:text-lg md:text-xl text-white/80 max-w-2xl">
                  Safety is not a priority — it's a value embedded in everything we do. We maintain rigorous standards across every site.
                </p>
              </motion.div>
              <motion.div
              ...
              >
                <img
                  src="https://cdn.builder.io/api/v1/image/assets%2Fc289c2c29f354ddfba7264f2fced3fad%2F080ebbec547348bc85fe0df1aa7550c0?format=webp&width=1200"
                  alt="Safety showcase"
