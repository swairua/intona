    ...
    <section className="py-16 md:py-24 bg-surface">
      <Container>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
          ...
          >
            <div className="w-12 sm:w-14 h-12 sm:h-14 rounded-2xl bg-primary/10 flex items-center justify-center mb-4 sm:mb-6">
              <svg className="w-6 sm:w-7 h-6 sm:h-7 text-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
              </svg>
            </div>
            <h3 className="text-xl sm:text-2xl font-bold text-accent mb-3 sm:mb-4">Our Mission</h3>
          ...
          >
            ...
            <h3 className="text-xl sm:text-2xl font-bold text-accent mb-3 sm:mb-4">Our Vision</h3>
            <p className="text-secondary leading-relaxed text-base sm:text-lg">
