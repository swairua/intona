...
export function HeroSection() {
  return (
    <section className="relative min-h-screen sm:min-h-screen flex items-center overflow-hidden">
      ...
      <Container className="relative z-20 pt-20 sm:pt-24 pb-12 sm:pb-16">
        <div className="max-w-4xl">
          ...
          >
            ...
            <button className="hidden sm:inline-flex items-center gap-3 px-6 py-3 text-white/70 hover:text-white transition-colors">
